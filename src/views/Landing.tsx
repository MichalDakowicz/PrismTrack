      ...
      >
        <div className="flex items-center justify-center gap-3 mb-4">
          <div className="w-12 h-12 bg-primary rounded-sm flex items-center justify-center">
            <Github className="w-8 h-8 text-on-primary" />
          </div>
          <h1 className="text-5xl font-black tracking-tighter text-text-main">PrismTrack</h1>
        </div>
        ...
        <div className="space-y-4">
          ...
          <p className="text-text-dim max-w-md mx-auto">
            Sync issues, PRs, and branches in real-time. The minimalist command deck for your GitHub workflow.
          </p>
        </div>
        ...
        <div className="pt-12 grid grid-cols-3 gap-8 text-left">
          <div className="space-y-2">
            <h3 className="font-mono text-xs uppercase tracking-widest text-primary">Native</h3>
            <p className="text-sm text-text-muted">GitHub is the single source of truth.</p>
          </div>
          <div className="space-y-2">
            <h3 className="font-mono text-xs uppercase tracking-widest text-accent">Fast</h3>
            <p className="text-sm text-text-muted">High-density, keyboard-first interface.</p>
          </div>
          <div className="space-y-2">
            <h3 className="font-mono text-xs uppercase tracking-widest text-text-main">Clean</h3>
            <p className="text-sm text-text-muted">Minimalist design, zero bloat.</p>
          </div>
        </div>
      </motion.div>
    </div>
